    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
                  ...
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        ...
                        url = "http://www.omdbapi.com/?apikey=".concat(apiKey, "&s=").concat(searchInput.value, "&page=").concat(clickedPage);
                        _context.next = 6;
                        return fetch(url);
          ...
          url = "http://www.omdbapi.com/?apikey=".concat(apiKey, "&s=").concat(searchInput.value);
          _context3.prev = 5;
          _context3.next = 8;
          return fetch(url);
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      ...
                      url = "http://www.omdbapi.com/?apikey=".concat(apiKey, "&t=").concat(clickedItem);
                      _context2.next = 5;
                      return fetch(url);
